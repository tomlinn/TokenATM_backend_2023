...
public interface EarnService {
    ...
    UseTokenResponse request_token_use(String user_id, String assignment_id, String assignment_name, Integer cost) throws IOException, BadRequestException, JSONException;
    ...
    CancelTokenResponse cancel_token_use(String user_id, String assignment_id, String assignment_name, Integer cost) throws IOException, BadRequestException, JSONException;
